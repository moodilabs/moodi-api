        ...
        RouteGenerateResult result = new RouteGenerateResult(
                ...
                List.of(
                        new DayResult(1, LocalDate.of(2026, 8, 10),
                                List.of(
                                        new SpotResult(1L, 1, 120, "경복궁", "https://img.example.com/1.jpg", "서울", "종로구", 37.5796, 126.9770, "관광지"),
                                        new SpotResult(2L, 2, 90, "국립현대미술관", "https://img.example.com/2.jpg", "서울", "종로구", 37.5788, 126.9808, "문화시설")
                                ),
                                List.of(new LegResultItem(1, 2, "WALK", 480, 650))
                        ),
                        new DayResult(2, LocalDate.of(2026, 8, 11),
                                List.of(
                                        new SpotResult(3L, 1, 60, "성수동 카페거리", "https://img.example.com/3.jpg", "서울", "성동구", 37.5445, 127.0560, "관광지"),
                                        new SpotResult(4L, 2, 120, "서울숲", "https://img.example.com/4.jpg", "서울", "성동구", 37.5444, 127.0374, "관광지")
                                ),
                                List.of(new LegResultItem(1, 2, "WALK", 900, 1200))
                        )
                )
        );
