        ...
        mockMvc.perform(get("/api/admin/members/{memberId}", MEMBER_ID))
                ...
                .andDo(document("admin/members/detail",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("data.agreements[].policyId").type(JsonFieldType.NUMBER).optional().description("동의 약관 policyId, 기존 기록은 null"),
                                fieldWithPath("data.agreements[].policyVersion").type(JsonFieldType.STRING).optional().description("동의 약관 policyVersion, 기존 기록은 null"),
                                fieldWithPath("data.agreements[].policyLocale").type(JsonFieldType.STRING).optional().description("동의 약관 policyLocale, 기존 기록은 null"),
